#!/usr/bin/env python3
"""Reserve a configured amount of GPU memory while CPU-only search runs."""
...
def main() -> None:
    ...
    parser.add_argument("--hold-gb", type=float, required=True, help="GiB per visible GPU")
    ...
    for index in range(torch.cuda.device_count()):
        ...
        # Keep a small allocation margin so CUDA context setup can finish.
        margin = 256 * 1024**2
