...
from method.margin_risk_conditional_rank_overlap_linearspec.hybrid import repeat_dynamic_cache
...
def main() -> int:
    ...
    specs = (
        ...
        forced_spec(draft, 1, positions[0], vocab_size, excluded, 3),
    ...
    if candidate_new is not None or set(candidate_drafts) != {
    ...
    continuation_logits, _, continuation_drafts, continuation_new = (
        _fused_verify_and_drafts(
            model,
            draft=forced,
            candidate_specs=(specs[0], specs[2]),
