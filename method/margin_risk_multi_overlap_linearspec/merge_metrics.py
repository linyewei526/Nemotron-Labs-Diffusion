#!/usr/bin/env python3
"""Merge fixed-margin-risk multi-overlap stats into NeMo-Skills metrics."""
...
def main() -> int:
    ...
    payload = {
        ...
        "metric_notes": {
            ...
            "outcome_states": "thirteen mutually-exclusive outcomes among actual multi-overlap attempts, including rank-specific candidate correction and full-block continuation states",
    ...
    metrics["pytorch_margin_risk_multi_overlap"] = payload
    ...
    summary_path = (
        ...
        else metrics_path.parent / "pytorch_margin_risk_multi_overlap_metrics_summary.json"
    )
