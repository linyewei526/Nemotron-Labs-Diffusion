#!/bin/bash
# Isolated fixed-margin-risk multi-overlap PyTorch + NeMo-Skills pipeline.
...
SEQ_EVAL_EXPNAME="${SEQ_EVAL_EXPNAME:-margin_risk_multi_overlap}"
...
echo "=============================================================="
echo " Margin-risk-multi-overlap LinearSpec + NeMo-Skills evaluation"
echo "=============================================================="
...
echo "[5/5] Completed margin-risk-multi-overlap PyTorch evaluation pipeline."
