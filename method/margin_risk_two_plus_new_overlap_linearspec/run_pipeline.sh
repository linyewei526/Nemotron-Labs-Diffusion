#!/bin/bash
# Isolated fixed-margin-risk P1/P2 plus always-New PyTorch + NeMo pipeline.
...
SEQ_EVAL_EXPNAME="${SEQ_EVAL_EXPNAME:-margin_risk_two_plus_new_overlap}"
...
echo "=============================================================="
echo " Margin-risk-two-plus-new-overlap LinearSpec + NeMo-Skills evaluation"
echo "=============================================================="
...
echo "[5/5] Completed margin-risk-two-plus-new-overlap PyTorch evaluation pipeline."
