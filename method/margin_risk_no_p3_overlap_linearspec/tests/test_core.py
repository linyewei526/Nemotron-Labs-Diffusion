...
from method.margin_risk_no_p3_overlap_linearspec.hybrid import (
    build_multi_hybrid_attention_mask,
    repeat_dynamic_cache,
    select_and_crop_cache,
)
from method.margin_risk_no_p3_overlap_linearspec.segmented_lora import (
...
class CoreTests(unittest.TestCase):
    ...
    def test_analyze_keeps_first_three_crossings_and_counts_all(self) -> None:
        ...
        self.assertEqual([item.confidence_rank for item in state.candidates], [2, 2])
    ...
    def test_candidate_and_omitted_p3_outcomes(self) -> None:
        specs = (
            candidate(1, 2, 20, 2),
            candidate(2, 4, 40, 2),
        )
    ...
    def test_branch_checks_only_executed_p1_p2(self) -> None:
    ...
    def test_crossing_cases_lock_no_p3_row_policy(self) -> None:
        stats = OverlapGenerationStats()
        ...
        expected_rows = {0: 2, 1: 3, 2: 4, 3: 3}
        self.assertEqual(expected_rows, {0: 1 + 1, 1: 1 + 2, 2: 1 + 3, 3: 1 + 2})
