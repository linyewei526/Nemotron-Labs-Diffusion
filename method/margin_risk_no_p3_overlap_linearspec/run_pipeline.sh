#!/bin/bash
# Isolated fixed-margin-risk no-P3 PyTorch + NeMo-Skills pipeline.
...
SEQ_EVAL_EXPNAME="${SEQ_EVAL_EXPNAME:-margin_risk_no_p3_overlap}"
...
echo "=============================================================="
echo " Margin-risk-no-P3-overlap LinearSpec + NeMo-Skills evaluation"
echo "=============================================================="
...
echo "[5/5] Completed margin-risk-no-p3-overlap PyTorch evaluation pipeline."
