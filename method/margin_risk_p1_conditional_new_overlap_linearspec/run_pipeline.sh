#!/bin/bash
# Isolated fixed-margin-risk P1-conditional-new PyTorch + NeMo-Skills pipeline.
...
SEQ_EVAL_BENCHMARK="${SEQ_EVAL_BENCHMARK:-gsm8k:1,human-eval:1,mbpp:1,math-500:1,aime25:1,gpqa:1,ifeval:1,livecodebench-cpp:1}"
SEQ_EVAL_EXPNAME="${SEQ_EVAL_EXPNAME:-margin_risk_p1_conditional_new_overlap}"
...
echo "=============================================================="
echo " Margin-risk-P1-conditional-new-overlap LinearSpec + NeMo-Skills evaluation"
echo "=============================================================="
...
echo "[5/5] Completed margin-risk-p1-conditional-new-overlap PyTorch evaluation pipeline."
