#!/usr/bin/env python3
"""Variable-length hybrid mask and DynamicCache helpers for MASK redraft."""
...
def build_mask_redraft_attention_mask(
    *,
    cache_length: int,
    verify_length: int,
    ...
    Row 0 contains a variable-length verifier followed by ignored padding.
    ...
    if not 2 <= verify_length <= prospective_length:
        raise ValueError("verify_length must be in [2, prospective_length]")
