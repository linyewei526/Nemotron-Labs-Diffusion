#!/bin/bash
# Isolated confidence-overlap PyTorch + NeMo-Skills pipeline.
...
OVERLAP_DROP_PCT_THRESHOLD="${OVERLAP_DROP_PCT_THRESHOLD:-0.15}"
...
SEQ_EVAL_EXPNAME="${SEQ_EVAL_EXPNAME:-confidence_overlap}"
...
echo "=============================================================="
echo " Confidence-overlap LinearSpec + NeMo-Skills evaluation"
echo "=============================================================="
echo " Mode:               $PYTORCH_MODE"
echo " Drop-pct threshold: $OVERLAP_DROP_PCT_THRESHOLD"
...
SERVER_ARGS=(
    ...
    --drop-pct-threshold "$OVERLAP_DROP_PCT_THRESHOLD"
...
echo "[5/5] Completed confidence-overlap PyTorch evaluation pipeline."
