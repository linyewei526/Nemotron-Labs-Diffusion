#!/usr/bin/env python3
"""Merge isolated confidence-overlap request stats into NeMo-Skills metrics."""
...
def main() -> int:
    ...
    metrics["pytorch_confidence_overlap"] = payload
    ...
    summary_path = (
        ...
        else metrics_path.parent / "pytorch_confidence_overlap_metrics_summary.json"
    )
